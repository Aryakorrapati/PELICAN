...
def define_model(trial):
    ...
    model = PELICANClassifier(args.num_channels_m, args.num_channels_2to2, args.num_channels_out, args.num_channels_m_out,
                      ...
                      activation=args.activation, sig=args.sig, config=args.config, config_out=args.config_out, factorize=args.factorize, masked=args.masked,
                      activate_agg_out=args.activate_agg_out, activate_lin_out=args.activate_lin_out, mlp_out=args.mlp_out,
                      scale=args.scale, ir_safe=args.irc_safe, dropout = args.dropout, drop_rate=args.drop_rate, batchnorm=args.batchnorm,
