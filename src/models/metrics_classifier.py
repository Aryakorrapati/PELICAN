...
def get_dynamic_smoothing(epoch, total_epochs, start_smoothing=0.12, final_smoothing=0):
    progress = epoch / total_epochs
    return (1 - progress) * start_smoothing + progress * final_smoothing

def Entropy(predict, targets, epoch, total_epochs):
    smoothing = get_dynamic_smoothing(epoch, total_epochs, start_smoothing=0.12, final_smoothing=0)
